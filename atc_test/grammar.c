...
static const char RCSID[] = "$NetBSD: grammar.y,v 1.8 2003/08/07 09:36:54 agc Exp $";
#endif
#endif /* not lint */
...
{
       0,    78,    78,    78,    87,    88,    92,    93,    94,    95,
      99,   111,   123,   135,   147,   149,   154,   156,   158,   160,
     165,   167,   172,   193,   195,   200,   226,   228,   233,   258,
     260,   265
};
#endif
...
{
  "$end", "error", "$undefined", "HeightOp", "WidthOp", "UpdateOp",
  "NewplaneOp", "DirOp", "ConstOp", "LineOp", "AirportOp", "BeaconOp",
  "ExitOp", "'='", "';'", "':'", "'('", "')'", "'['", "']'", "$accept",
  "file", "$@1", "bunch_of_defs", "def", "udef", "ndef", "hdef", "wdef",
  "bunch_of_lines", "line", "Bpoint_list", "Bpoint", "Epoint_list",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,    61,    59,    58,    40,    41,    91,    93
};
# endif
...
#line 286 "grammar.y" /* yacc.c:1906  */
